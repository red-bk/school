...
export default function UpdatePage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    if (!file) {
      setMessage("الرجاء اختيار الملف البديل.");
      return;
    }
    ...
    <main className="flex min-h-screen items-center justify-center px-4 py-10">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-md">
        ...
        <p className="mb-6 text-sm text-slate-500">
          أدخل الرقم التعريفي للمعلم ونوع الورقة لاستبدال الملف الحالي بملف
          جديد.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            {status === "loading" ? "جاري التحديث..." : "تحديث الملف"}
          </button>
        ...
        <p className="mt-5 text-center text-sm text-slate-500">
          تريد رفع ملف جديد بدلاً من ذلك؟{" "}
          <a href="/" className="font-medium text-slate-800 underline">
